 ...
 *
 * @brief Header file of the prime-field arithmetic.
 *
 * @details 
 * This file contains some constants and function prototypes of the (4*1)-way
 * vectorized prime-field operations. 
*******************************************************************************
 */
