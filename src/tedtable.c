 ...
 *
 * @brief C source file with table of pre-computed points and load function.
 * 
 * @details 
 * This file contains the pre-computed table of multiples of the base point
 * (in Duif representation) and functions to load table-entries in constant
 * time.
 ******************************************************************************
 */
...
// forward declaration of base-table 
static const LutPoint base[32][8];
...
// look-up table containing multiples of base point
static const LutPoint base[32][8] = 
{
  { // base[0][0] - base[0][7]
    {
