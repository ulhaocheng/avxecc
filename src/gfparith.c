 ...
 *
 * @brief C source file of the prime-field arithmetic.
 *
 * @details 
 * This file contains the (4*1)-way vectorized prime-field operations. 
 * The modulus p is 64*(2^255-19). 
 * Updates: Use local variables to represent all limbs of the operands and the
 * result in each arithmetic function. According to our experimental results,
 * this modification reduces the latency by about 5% on Skylake, but increases
 * the latency a little bit on Haswell.  
 ******************************************************************************
 */
