 ...
 *
 * @brief C source file of ECDH key exchange functions
 *
 * @details 
 * This file contains the ECDH key-pair generation and the computation of the
 * shared secret.
 ******************************************************************************
 */
...
/**
 * @brief The final step to reduce pk or ss modulo p 
 *
 * @details
...
{
  // Fixed-base scalar multiplication on twisted Edwards curve, followed by a
  // conversion of the obtained point to the corresponding Montgomery curve
...
{
  // Variable-base scalar multiplication on Montgomery curve
